<h2><a href="https://leetcode.com/problems/ways-to-express-an-integer-as-sum-of-powers/">2787. Ways to Express an Integer as Sum of Powers</a></h2><h3>Medium</h3><hr><p>Given two <strong>positive</strong> integers <code>n</code> and <code>x</code>.</p>
