<h2><a href="https://leetcode.com/problems/lexicographically-smallest-beautiful-string">2663. Lexicographically Smallest Beautiful String</a></h2><h3>Hard</h3><hr><p>A string is <strong>beautiful</strong> if:</p>
