<h2><a href="https://leetcode.com/problems/verbal-arithmetic-puzzle/">1307. Verbal Arithmetic Puzzle</a></h2><h3>Hard</h3><hr><p>Given an equation, represented by <code>words</code> on the left side and the <code>result</code> on the right side.</p>
